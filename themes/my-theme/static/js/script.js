...
// function changeColorFromTo(pageInfo){
//   console.log(localStorage.getItem("prevColor")); 
//   $("body").css("color", localStorage.getItem("prevColor"));
//   $("body").addClass(pageInfo);
//   // $('body.blank').css("color",localStorage.getItem("prevColor"));
//   const combinedString = 'body.'+ pageInfo;
//   // console.log($(combinedString).css('color'));
//   setTimeout(function() { 
//     $currentFontColor = $(combinedString).css('color');
//     console.log($currentFontColor); 
//     localStorage.setItem("prevColor",$currentFontColor);
//   }, 1000);
// }
...
//   appNavItem.addEventListener('click', function(ev) {
